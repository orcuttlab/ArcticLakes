...
seqtab2 <- seqtab[,nchar(colnames(seqtab)) %in% seq(190,200)] # Selection of Amplicon length to keep
...
saveRDS(seqtab.nochim, file = "arctic_V4_asv") # Files uploaded to Github
saveRDS(taxa, file = "arctic_V4_taxa")# Files uploaded to Github
